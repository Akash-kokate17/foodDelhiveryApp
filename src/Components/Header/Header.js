      ...
      <div className="container">
        <div className="row align-items-center">
          ...
          <div className="col-md-3 text-end">
            <div className={`dropdown ${style.profileDropdown}`}>
              <p
              ...
              >
                ...
                <li>
                  <span className="dropdown-item text-center">Notification</span>
                </li>
                <li>
                ...
                <li>
                  <span className="dropdown-item text-center">Find Friends</span>
                </li>
                <li>
                  <span className="dropdown-item text-center">Setting</span>
                </li>
                <li>
                  <Link to="/" className="dropdown-item text-center" style={{ textDecoration: "none" }}>Log Out</Link>
                </li>
              </ul>
            </div>
          </div>
